...
5. Se sugiere que por operación y modo de procesamiento se hagan minimo 5 repeticiones. Se sugiere de igual forma que, dicho número sea el mismo para las 3 computadoras, de modo que se faciliten los calculos.
